...
/* Change group logo URL */
const groupLogoUrl = "https://www.business2community.com/wp-content/uploads/2022/06/optimism-logo-600x338.png";
/* END */
...
export function GroupDetails() {
  ...
  function GroupPfp({onClick}) {
    ...
    return <img src={groupLogoUrl} alt="Group logo" />;
